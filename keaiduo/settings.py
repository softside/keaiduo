...
DATABASES = {
    'default': {
        ...
        'NAME':'uibeswan',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '9$#738(jmegj766d=su9xs&amp;xt)mp35t(y8kky2=3u9z(8hdw6='
...
ROOT_URLCONF = 'keaiduo.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'keaiduo.wsgi.application'
